...
func (c ConsoleUI) Println(format string, a ...any) {
	fmt.Println(fmt.Sprintf(format, a...))
}

func (c ConsoleUI) Debug(format string, a ...any) {
	if c.debug {
		fmt.Println(noteColor("[DEBUG] "), fmt.Sprintf(format, a...))
	}
}
